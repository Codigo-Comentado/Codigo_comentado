 ...
 *
 * @modulo         Programação Orientada a Objetos (POO)
 * @roadmap        Módulo POO → A01
 * @trilha         JavaScript → POO → Básico
 * @nivel          🟢 Básico
 * @prerequisitos  Lógica de programação básica (variáveis, tipos, funções)
