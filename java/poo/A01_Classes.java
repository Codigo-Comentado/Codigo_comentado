...
/**
 * A01 — Classes e Objetos
 *
 * @modulo         Programação Orientada a Objetos
 * @roadmap        Módulo 3 → A01
 * @trilha         Java → POO → Básico
 * @nivel          🟢 Básico
 * @prerequisitos  Lógica de programação básica (variáveis, tipos, métodos)
 * @proximos       Objetos, Atributos, Métodos
 *
 * @autor          Morcineck
...
public class A01_Classes {
     ...
     * seja, dois objetos da mesma classe são "parentes" na forma,
     * mas independentes no conteúdo.
     */
     ...
     * si, por exemplo, várias variáveis separadas para nome, preço
     * e estoque de um produto, sem nada que amarre essas informações
     ...
     *    pessoa (nome, idade e cidade), assim como mostrado no
     *    código acima em exibirDetalhes na classe Produto.
     * 3. No main, crie pelo menos dois objetos Pessoa diferentes, com
     *    valores distintos, e chame o método exibirDados de cada um.
     *
