"""
A0X - [Nome do tema aqui - ex: Herança, Dicionários, Try/Except]

@modulo         [Nome do módulo — ex: Programação Orientada a Objetos]
@roadmap        Módulo [X] → A0X
@trilha         Python → [Módulo] → [Nível]
...
# TODO: renomeie este arquivo seguindo o padrão A0X_Tema.py (ex: A03_Self.py)
...
# Ex: "Imagine que self é como dizer 'eu mesmo' apontando para você
# Numa sala cheia de pessoas com o mesmo nome."]
...
def main():
    ...
    # para o tema. Nem todo tema precisa de uma main funcional
...
# explique com as suas próprias palavras por que você usou (ou não)
